...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/SMS_HELP_CENTER")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1002607308950').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001709789024')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001973700941')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'a844475f608c20832ff8e71170aedbe7751cc129')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/SMS_MAIN_GROUP')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/SMS_MAIN_CHANNELS')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Link_Opening/3')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Nanbha and Nanbis ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002066335972'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'SMS_MAIN_CHANNELS')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002006462285')).split()]
